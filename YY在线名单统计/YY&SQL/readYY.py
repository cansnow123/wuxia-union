...
sh1 = wb.sheet_by_name('万星楼')
sh2 = wb.sheet_by_name('天纵')
sh3 = wb.sheet_by_name('陌上花开')
sh4 = wb.sheet_by_name('奇谷')
...
Replace_Dict = [
    ...
    ['醉噵', ['酒醒踏紅尘丶']],
    ['❀秋分❀', ['迷路的沫沫']],
    ['皇族丿凌风', ['黑恶势力的绿毛', '黑恶势力的毒哥', '黑恶势力的帅白', '黑恶势力的医师']],
...
UNIONL = sh2arr(sh1) + sh2arr(sh2) + sh2arr(sh3) + sh2arr(sh4)
